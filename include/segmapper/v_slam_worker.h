...
static VSlamWorkerParams getLaserSlamWorkerParams(const ros::NodeHandle& nh,
...
public:
  ...
  void init(ros::NodeHandle& nh, const VSlamWorkerParams& params,
  ...
  void poseCallback(const geometry_msgs::PoseStamped& pose_msg_in);
  ...
  bool getQueuedScanAndPose(LocalMap& local_map);
